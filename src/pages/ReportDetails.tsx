...
import { FileText, Calendar, Share2, Download, ArrowLeft, Edit, Trash, Printer } from 'lucide-react';
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <p className="font-medium">{report.ocrResult.processing_time.toFixed(2)} seconds</p>
                      </div>
                      <div>
