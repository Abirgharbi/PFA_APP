...
//4.233.146.155
let apiUrl = 'http://4.233.146.155:5000/api'; // default for web
...
if (platform !== 'web') {
  ...
  apiUrl = platform === 'android'
    ? 'http://4.233.146.155:5000/api'
    : 'http://4.233.146.155:5000/api'; // replace with your local IP for real device
}
